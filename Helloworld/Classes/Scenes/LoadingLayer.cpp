...
/*
//CcbManager.h
CCNode* LoadLoadingLayer( CCObject* owner );

//CcbManager.cpp
CCNode* CcbManager::LoadLoadingLayer( CCObject* owner ) {
	CCNodeLoaderLibrary* pLoaderLib = CCNodeLoaderLibrary::newDefaultCCNodeLoaderLibrary();
	pLoaderLib->registerCCNodeLoader("LoadingLayer", LoadingLayerLoader::loader());
    
	CCBReader* pCCBReader = new CCBReader(pLoaderLib);
	CCNode* pNode = pCCBReader->readNodeGraphFromFile("ccb/loding.ccbi", owner);
	pCCBReader->release();
...
SEL_CallFuncN LoadingLayer::onResolveCCBCCCallFuncSelector( CCObject * pTarget, const char* pSelectorName )
{
...
bool LoadingLayer::onAssignCCBCustomProperty(cocos2d::CCObject *pTarget, const char *pMemberVariableName, cocos2d::extension::CCBValue *pCCBValue)
{
